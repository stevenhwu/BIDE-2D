...
@RunWith(Suite.class)
@SuiteClasses({ CurrentParTest.class, ParGlobalTest.class, ParSpotTest.class,
		SaveParGlobalTest.class, SaveParLocalTest.class })
public class AllTestsCorePar {
